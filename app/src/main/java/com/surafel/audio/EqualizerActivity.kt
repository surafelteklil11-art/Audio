...
class EqualizerActivity : AudioToolPageActivity() {
    ...
    private class HudFrameDrawable(private val activity: EqualizerActivity, private val header: Boolean) : Drawable() {
        ...
        override fun draw(canvas: Canvas) {
            ...
            canvas.drawLine(b.left + inner + cut, b.top + activity.dp(7), b.right - inner - cut, b.top + activity.dp(7), paint)
            canvas.drawLine(b.left + inner + cut, b.bottom - activity.dp(7), b.right - inner - cut, b.bottom - activity.dp(7), paint)
