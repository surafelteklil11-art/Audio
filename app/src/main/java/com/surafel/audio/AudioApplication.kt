...
object BackgroundManager {
    ...
    fun apply(activity: Activity) {
        ...
        if (activity is EthiopianCalendarActivity || activity is CheckersActivity || activity is FullscreenVideoActivity || activity is com.surafel.audio.pdf.PdfUiActivity) return
