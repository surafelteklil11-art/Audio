...
class PianoBoardView(context: Context, val engine: PianoEngine,
    ...
    init { isFocusable = true; isFocusableInTouchMode = true; contentDescription = "Four piano lanes. Tap tiles at the glowing line. Keep long tiles pressed. Keys 1 to 4 also play." }
